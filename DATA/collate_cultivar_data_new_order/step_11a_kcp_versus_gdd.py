...
# =============================================================================
if os.path.exists("./figures/smoothed_cumul_gdd.png"):
    os.remove("./figures/smoothed_cumul_gdd.png")
    print("Removed the file: smoothed_cumul_gdd.png.")
if os.path.exists("./data/smoothed_cumul_gdd_vs_season_day.xlsx"):
    os.remove("./data/smoothed_cumul_gdd_vs_season_day.xlsx")
    print("Removed the file: smoothed_cumul_gdd_vs_season_day.xlsx.")
if os.path.exists("./figures/kcp_versus_gdd.png"):
    os.remove("./figures/kcp_versus_gdd.png")
    print("Removed the file: kcp_versus_gdd.png.")
if os.path.exists("./data/kcp_vs_smoothed_cumul_gdd.xlsx"):
    os.remove("./data/kcp_vs_smoothed_cumul_gdd.xlsx")
    print("Removed the file: kcp_vs_smoothed_cumul_gdd.xlsx.")
# =============================================================================
