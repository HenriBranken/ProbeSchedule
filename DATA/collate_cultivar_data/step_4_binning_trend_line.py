...
# kcp_vs_days_df contains the weighted-moving-average kcp trend as a function of datatimeStamp
...
cleaned_kcp_df = pd.read_excel("./data/kcp_vs_days.xlsx", names=["days", "kcp"], index_col=0, parse_dates=True)
# ----------------------------------------------------------------------------------------------------------------------
...
# Create a pandas DataFrame, called kcp_vs_week_df.  kcp_vs_week_df contains the columns:
#   datetimestamp --> the index of the DataFrame
...
# Create a pandas DataFrame, called kcp_vs_month_df.  kcp_vs_month_df contains the columns:
#   datetimestamp --> the index of the DataFrame
