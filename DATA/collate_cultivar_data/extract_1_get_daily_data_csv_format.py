...
#    [start_date; end_date].
# 2. The probe NUMBERS for which we need to extract data.  This needs to be
#    specified in `devices`.  Later in the code, we loop over `devices` to
#    extract the individual probe data.
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
starting_year = datetime.datetime.strptime(start_date, "%Y-%m-%d").year
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
# Create `./api_dates.txt` containing the API beginning and ending dates.
