...
# print(from_season_week_to_kcp_dict)
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++


# ======================================================================================================================
# Project the weekly data into daily bins.
# ======================================================================================================================
datetime_stamp = []
repeated_kcp = []
season_day = []
...
repeated_df = pd.DataFrame(data=dict_for_df, index=datetime_stamp, copy=True)
repeated_df.index.name = "datetime_stamp"
# ======================================================================================================================


# ----------------------------------------------------------------------------------------------------------------------
# Show a plot of the weekly data that is pojected onto daily bins
# ----------------------------------------------------------------------------------------------------------------------
...
ax.plot(repeated_df["season_day"].values, repeated_df["repeated_kcp"].values, lw=2)
ax.set_xlim(left=repeated_df["season_day"].values[0], right=repeated_df["season_day"].values[-1])
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
repeated_df.to_excel("./data/projected_data.xlsx", float_format="%.7f", header=True, index=True,
