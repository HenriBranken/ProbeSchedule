...
with pd.ExcelWriter('Golden_Delicious_daily_data.xlsx', date_format="yyyy-mm-dd", datetime_format="yyyy-mm-dd",
...
with pd.ExcelWriter('Golden_Delicious_probe_data.xlsx', date_format="yyyy-mm-dd", datetime_format="yyyy-mm-dd HH:MM:SS",
    ...
    p1426_probe_df.to_excel(writer, header=True, index=True, sheet_name="P-1426", index_label="datetime", verbose=True)
